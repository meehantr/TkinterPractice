...
def main():
    ...
    #      n = int(s)
    ####################################################################
    entry_box_int = ttk.Entry(frame1)
    entry_box_int.grid()

    print_button = ttk.Button(frame1, text='Print loop')
    print_button.grid()

    print_button['command'] = lambda: print_loop(my_entry_box, entry_box_int)
    # ------------------------------------------------------------------
...
def print_loop(entry_box_print, entry_box_int):
    N = int(entry_box_int.get())
    for i in range(N):
        print(entry_box_print.get())
